...
public class ZerarDialog extends android.support.v4.app.DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alertDialogBuilder
                .setMessage(res.getString(R.string.dialog_zerar_text));
        ...
        alertDialogBuilder.setCancelable(true).setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Command cmd = new Zerar(aController);
                        cmd.Execute();
                    }
                });
        ...
        alertDialogBuilder.setTitle(res.getString(R.string.dialog_zerar_title));
