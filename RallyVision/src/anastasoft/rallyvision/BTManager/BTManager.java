package anastasoft.rallyvision.BTManager;
...
public class BTManager {
    ...
    private int mState;
    private Resources aResource;
    // device
    private String connectedAddress;

    public BTManager(Controller apController, Handler mHandler) {
        // TODO Auto-generated constructor stub
        aController = apController;
        this.mHandler = mHandler;
        aResource = aController.getResources();
    }
    ...
    public void connectToDeviceWith(String address) {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Controller.TOAST,
                aResource.getString(R.string.message_unable_connect));
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Controller.TOAST,
                aResource.getString(R.string.message_connection_failed));
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    //aTimAdpt.endTimeCount();

                    msg = mHandler.obtainMessage(Controller.MESSAGE_READ,
                            bytes, -1, buffer);
                    Bundle bundle = new Bundle();

                    //bundle.putLong(Controller.TIME, aTimAdpt.getDeltaT());
                    msg.setData(bundle);
                    msg.sendToTarget();
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                // (TelephonyManager)aController.getCurrentActiviy().getSystemService(Context.TELEPHONY_SERVICE);
                // String uuid = tManager.getDeviceId();
                // UUID aUUID = UUID.fromString(uuid);
